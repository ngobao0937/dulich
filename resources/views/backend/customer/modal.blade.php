<div id="myModal" class="modal fade" role="dialog" data-id="0">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form action="{{ route('backend.customer.delete', request()->query()) }}" method="post">
                @csrf @method('DELETE')
                ...
                <div class="modal-body">
                    <p>Bạn có thật sự muốn xóa người đăng ký nhận ưu đãi này?</p>
...
<div id="customerModal" class="modal fade" role="dialog" aria-labelledby="customerModalLabel">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('backend.customer.store', request()->query()) }}" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                                <label>Tên Customer <span class="text-danger">*</span></label>

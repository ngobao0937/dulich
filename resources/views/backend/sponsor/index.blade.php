        ...
        <div class="card">
            <div class="card-header">
                <div class="div-header" style="display: flex; justify-content: space-between; flex-wrap: nowrap; gap: 10px;">
                    <a class="btn btn-success btn-sm" data-toggle="modal" data-target="#sponsorModal">
                        Thêm mới
                    </a>
                    <form method="GET" action="{{ route('backend.sponsor.index') }}" class="form-inline" id="search-form">
                        <div class="input-group input-group-sm">
                            ...
                            <div class="input-group-append">
                                ...
                                @if(request('search'))
                                <a type="button" class="btn btn-default" href="{{ route('backend.sponsor.index') }}"><i class="fas fa-times"></i></a>
                                @endif 
                            </div>
                        </div>
                    </form>

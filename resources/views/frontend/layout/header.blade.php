<header class="w-100 transparent-header">
    <nav class="navbar navbar-expand-lg navbar-dark d-flex justify-content-between align-items-center padding-header">
        ...
        <div class="d-flex w-100 justify-content-between">
            ...
            <a href="javascript:void(0)" class="btn pl-3 pr-3 register-header" onclick="openFormRegister(0)" style="background: white; border-radius: 20px; z-index: 2;"><b style="color: #38b19e;">ĐĂNG KÝ</b></a>
        </div>
...
<div id="mobileSidebar" class="mobile-sidebar">
    <div class="sidebar-content">
        ...
        <ul class="list-unstyled mt-4">
            ...
            <li><a href="javascript:void(0)" class="btn pl-3 pr-3 mt-3" onclick="openFormRegister(0)" style="background: white; border-radius: 20px;"><b style="color: #38b19e;">ĐĂNG KÝ</b></a></li>
        </ul>
    </div>
</div>
